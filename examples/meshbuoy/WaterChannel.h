...
#define MESHBUOY_MSG_MAX_LEN 48

// Hashtag-channel key derivation and message formatting for MeshBuoy.
...
public:
  ...
  // MESHBUOY_CHANNEL_NAME, remainder zeroed) and channel.hash (1-byte
  ...
  // `out` must be at least MESHBUOY_MSG_MAX_LEN bytes.
