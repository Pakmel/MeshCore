...
// the upstream base is updated - it is NOT MESHTEMP_VERSION.
...
// it identify MeshTemp and its own version, not just the upstream MeshCore
// version, which is otherwise indistinguishable from stock firmware.
// Sourced from MESHTEMP_VERSION in meshtemp_version.h so it can't drift.
#ifndef FIRMWARE_VERSION
  #define FIRMWARE_VERSION   "MeshTemp " MESHTEMP_VERSION " (MeshCore " MESHCORE_UPSTREAM_VERSION ")"
#endif
