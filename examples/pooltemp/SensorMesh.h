...
// the upstream base is updated - it is NOT POOLTEMP_VERSION.
...
// it identify PoolTemp and its own version, not just the upstream MeshCore
// version, which is otherwise indistinguishable from stock firmware.
// Sourced from POOLTEMP_VERSION in pooltemp_version.h so it can't drift.
#ifndef FIRMWARE_VERSION
  #define FIRMWARE_VERSION   "PoolTemp " POOLTEMP_VERSION " (MeshCore " MESHCORE_UPSTREAM_VERSION ")"
#endif
