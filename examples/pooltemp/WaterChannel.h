...
#define POOLTEMP_MSG_MAX_LEN 48

// Hashtag-channel key derivation and message formatting for PoolTemp (see
...
public:
  ...
  // POOLTEMP_CHANNEL_NAME, remainder zeroed) and channel.hash (1-byte
  ...
  // `out` must be at least POOLTEMP_MSG_MAX_LEN bytes.
