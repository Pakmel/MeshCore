...
#include "pooltemp_config.h"   // MAX_TIME_SYNC_CANDIDATES - needed for the array sizes below
...
public:
  ...
  // Boot-phase retry, driven on the POOLTEMP_SYNC_RETRY_SECS cadence while
